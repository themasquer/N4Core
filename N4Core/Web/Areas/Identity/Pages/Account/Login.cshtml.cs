...
namespace N4Web.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, CultureUtilBase cultureUtil, CookieUtilBase cookieUtil)
        {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Display(Name = "{Remember me?;Beni hatırla?}")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, Input.Language == Languages.English ? "Invalid login attempt." : "Geçersiz giriş.");
                }
            }
